export const Arabic: any = {
  ...
  copyRights1: "جميع الحقوق محفوظة |",
  copyRights2: "",
  terms: "شروط",
  policy: "احكام",
  ...
  Home: {
    ...
    AboutContent: "نحن ملتزمون بتقديم أفضل خدمة وساطة مالية من حيث التداول والبحث وذلك من خلال معلومات دقيقة وشفافة قبل اتخاذ قرار مالي شخصي مستنير، يمكنك الآن الرجوع إلى تفاصيل المنتج المدروسة جيدًا والمنظمة، بالإضافة إلى أدوات المقارنة، قبل اتخاذ قرار تمويل شخصي مستنير.",
    AboutContent1: "نحن نتحدث عنك! نقدم رأيًا محايدًا وغير متحيز حول جميع خدمات التمويل الشخصي، مما يضع امامك كافة الخيارات المتاحة لتحديد أفضل بطاقات الائتمان وعروض القروض والحلول الأكثر تميزا.",
